...
namespace Gianluca_GitHub
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Creare il mio socketlistene
            // 1) specifico che versione ip
            // 2) il tipo di socket. Stream.
            // 3) protocollo a livello di trasporto
            Socket listenerSocket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);

            // confing: IP deve ascoltare. Possiamo usare l'opzione Any: ascolta da tutte le interfaccie all'interno del mio pc
            ...
            // mi attrezzo per riceve un messaggio dal client
